...
import software.xdev.micromigration.migrater.reflection.ScriptInstantiationException;
	...
	public static void main(final String[] args)
	{
		try
		{
			final ReflectiveMigrater migrater =
				new ReflectiveMigrater("software.xdev.micromigration.examples.reflective.scripts");
		...
		{
			throw new IllegalStateException("Could not initiate migration script", e);
		}
	}
	
	private MainReflective()
	{
	}
}
