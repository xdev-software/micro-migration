...
public class UpdateToV1_0 implements MigrationScript<software.xdev.micromigration.examples.practical.v0.BusinessBranch>
{
	...
	@Override
	public void migrate(final Context<software.xdev.micromigration.examples.practical.v0.BusinessBranch,
		MigrationEmbeddedStorageManager> context)
	{
		Logger.getGlobal().info("Executing Script for v1.0...");
		final software.xdev.micromigration.examples.practical.v0.BusinessBranch oldBranch =
			context.getMigratingObject();
